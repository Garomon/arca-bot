/**
 * Fix ALL sells with negative profit
 * A grid bot should never have negative profit per trade (buy low, sell high)
 * Recalculate using proper grid spacing
 */
const fs = require('fs');
...
for (const order of state.filledOrders) {
    // Fix ALL sells with negative or zero profit
